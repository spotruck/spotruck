...
export default function EvenementPage() {
  ...
  const publier = useCallback(() => {
    const evt = {
      titre, typeEvt, description, dateDebut, dateFin, heureDebut, heureFin,
      lieu, visiteurs, nbTrucksCount, truckDetails, recherche, tranches, modele, modeleResume: modeleResume(),
      elec, surface, acces, docs, noteMin, exclu, excluType, dateLimite, instructions,
      modesCand, contratMode, statut:"ACTIF", publieLe: new Date().toISOString(),
    };
    const list: unknown[] = (() => { try { return JSON.parse(localStorage.getItem("spotruck_org_evenements") ?? "[]"); } catch { return []; } })();
    list.push(evt);
    saveLS("spotruck_org_evenements", list);
  ...
  }, [titre, typeEvt, description, dateDebut, dateFin, heureDebut, heureFin, lieu, visiteurs, nbTrucksCount, recherche, tranches, modele, elec, surface, acces, docs, noteMin, exclu, excluType, dateLimite, instructions, modesCand, contratMode, router]);
  ...
  }, [titre, typeEvt, description, dateDebut, lieu]);
          ...
          <div>
            ...
            <div style={{ marginTop:"2rem", display:"flex", justifyContent:"space-between", alignItems:"center", flexWrap:"wrap", gap:"1rem" }}>
              ...
              <div style={{ display:"flex", gap:"0.75rem" }}>
                ...
                <button onClick={publier} style={{ backgroundColor:S.terra, color:"#fff", border:"none", padding:"0.875rem 2rem", fontFamily:S.sans, fontSize:"0.65rem", letterSpacing:"0.2em", cursor:"pointer", display:"flex", alignItems:"center", gap:"0.5rem" }}>
                  <Zap size={14} strokeWidth={2} /> PUBLIER L'ÉVÉNEMENT{proEventActive && " + PRO EVENT"}
                </button>
              </div>
            </div>
          </div>
            ...
            <div style={{ display:"flex", flexDirection:"column", gap:"2rem" }}>
              ...
              <section>
                ...
                <div style={{ backgroundColor:S.card, padding:"1.25rem", display:"grid", gridTemplateColumns:"1fr 1fr", gap:"0.75rem" }}>
                  <Field label="NOM / RAISON SOCIALE" value="Sophie Mercier — Association Culturelle" onChange={() => {}} />
        ...
        <div style={{ position:"fixed", inset:0, backgroundColor:"rgba(0,0,0,0.65)", zIndex:4000, display:"flex", alignItems:"flex-start", justifyContent:"center", padding:"2rem", overflowY:"auto" }}>
          <div style={{ backgroundColor:"#fff", width:"100%", maxWidth:680, padding:"3.5rem 4rem", position:"relative", marginTop:"2rem", marginBottom:"2rem", fontFamily:"Georgia, serif", lineHeight:1.8 }}>
            ...
            <p style={{ marginBottom:"1.5rem", color:"#333", fontSize:"0.9rem" }}>
              Entre <strong>Sophie Mercier — Association Culturelle</strong>{siretOrga && `, SIRET ${siretOrga}`}{adresseOrga && `, ${adresseOrga}`}, ci-après dénommée <em>"l'Organisateur"</em>,<br /><br />
            ...
            <div style={{ marginTop:"3rem", display:"grid", gridTemplateColumns:"1fr 1fr", gap:"2rem" }}>
              <div>
                ...
                <p style={{ fontFamily:"'Inter',sans-serif", fontSize:"0.65rem", color:"#999", marginTop:"0.25rem" }}>Sophie Mercier — Date : ___________</p>
              </div>
              <div>
